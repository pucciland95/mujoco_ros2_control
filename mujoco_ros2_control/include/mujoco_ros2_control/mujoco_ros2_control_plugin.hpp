...
class MJResourceManager : public hardware_interface::ResourceManager
{
   ...
   bool load_and_initialize_components(const std::string& urdf, unsigned int update_rate) override
   {
      ...
      for (const auto& individual_hardware_info : hardware_info)
      {
         ...
         try
         {
            ...
            p_mujoco_system = mujoco_system.get();
         }
 ...
 private:
   ...
   mujoco_ros2_control::MujocoSystemInterface* p_mujoco_system;
...
class MujocoRos2ControlPlugin
{
 ...
 public:
   ...
   */
   ...
   /** \brief checks whether the controllers are loaded.
    */
 ...
 protected:
   ...
   mujoco_ros2_control::MJResourceManager* p_mj_resource_manager_;
